...
export default {
  ...
  methods: {
    ...
    displayEarth() {
      const scale = 0.25;
      this.earthObject = this.earthGLTFObject.scene.children[0].children[0];
    ...
    rotateEarthToGreenWichAndEquator() {
      this.earthObject.rotation.x = -1.55;
      this.earthObject.rotation.y = -0.25;
      this.earthObject.rotation.z = -2;
    },
    ...
    addDebugGUI() {
      // earth rotation
      this.gui.add(this.earthObject.rotation, "x", -2, 2, 0.01);
      this.gui.add(this.earthObject.rotation, "y", -2, 2, 0.01);
      this.gui.add(this.earthObject.rotation, "z", -2, 2, 0.01);
